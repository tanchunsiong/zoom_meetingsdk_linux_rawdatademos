...
public:
	MeetingShareCtrlEventListener(void (*onShareSourceChanged)(ZoomSDKSharingSourceInfo shareInfo) = nullptr);
...
private:
	void (*onShareSourceChanged_)(ZoomSDKSharingSourceInfo shareInfo);
