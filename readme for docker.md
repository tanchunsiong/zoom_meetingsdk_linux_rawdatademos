...
docker run --cpus=2.0 --memory=4G -it --rm msdk-5.16.0-on-ubuntu-compact

# build UbuntuDesktop
docker build -t msdk-5.16.0-on-ubuntudesktop-compact -f Dockerfile-UbuntuDesktop/Dockerfile .
docker run -it --rm msdk-5.16.0-on-ubuntudesktop-compact
