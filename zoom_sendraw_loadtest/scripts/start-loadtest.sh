...
usage() {
  echo "Usage: $0 COUNT MEETING_NUMBER [MEETING_PASSWORD] [USERNAME_PREFIX]" >&2
  echo "Example: $0 25 1234567890 'passcode' LoadBot" >&2
}
...
COUNT=$1
MEETING_NUMBER=$2
MEETING_PASSWORD=${3:-${MEETING_PASSWORD:-}}
USERNAME_PREFIX=${4:-${ZOOM_USERNAME_PREFIX:-ZoomLoadBot}}
...
for i in $(seq 1 "$COUNT"); do
  ...
  args+=(
    ...
    -e "JWT_ROLE=${JWT_ROLE}"
    -e "USE_JWT_TOKEN_FROM_WEB_SERVICE=${USE_JWT_TOKEN_FROM_WEB_SERVICE:-true}"
