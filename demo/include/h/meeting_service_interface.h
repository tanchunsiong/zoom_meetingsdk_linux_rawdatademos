...
typedef struct tagJoinParam4WithoutLogin
{
	...
	const zchar_t* customer_key;///<The customer key that need the app intergrated with sdk to specify. The SDK will set this value when the associated settings are turned on.
