...
{
	if ( NULL == _network_connection_helper)
	{
...
// {
// 	if (NULL == _meeting_chat_ctrl && _meeting_service)
// 	{
// #if defined(WIN32)
...
{
	if (NULL == _meeting_participants_ctrl && _meeting_service)
	{
...
// {
// 	if (NULL == _close_caption_ctrl && _meeting_service)
// 	{
// #if defined(WIN32)
...
{
	if (NULL == _meeting_video_ctrl && _meeting_service)
	{
