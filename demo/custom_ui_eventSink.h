...
//	virtual void onRecording2MP4Processing(int iPercentage) = 0;
	virtual void onUserJoin(ZOOM_SDK_NAMESPACE::IList<unsigned int >* lstUserID, const zchar_t* strUserList = NULL) = 0;
	virtual void onUserLeft(ZOOM_SDK_NAMESPACE::IList<unsigned int >* lstUserID, const zchar_t* strUserList = NULL) = 0;
	...
	virtual void onUserAudioStatusChange(ZOOM_SDK_NAMESPACE::IList<ZOOM_SDK_NAMESPACE::IUserAudioStatus* >* lstAudioStatusChange, const zchar_t* strAudioStatusList = NULL) = 0;
	...
	virtual void onChatMsgNotifcation(ZOOM_SDK_NAMESPACE::IChatMsgInfo* chatMsg, const zchar_t* ccc) = 0;
	...
	virtual void onGetAudioAndVideoSettingFlags(const zchar_t* audioFlag, const zchar_t* videoFlag) = 0;
...
public:
	...
	// virtual void onChatMsgNotifcation(ZOOM_SDK_NAMESPACE::IChatMsgInfo* chatMsg, const zchar_t* ccc) {}
