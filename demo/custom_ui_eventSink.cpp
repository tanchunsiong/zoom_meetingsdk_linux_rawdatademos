...
void CSDKCustomUIWorkFlow::onUserJoin(ZOOM_SDK_NAMESPACE::IList<unsigned int >* lstUserID, const zchar_t* strUserList)
{
	if(m_pCustomUIEvent)
		m_pCustomUIEvent->onUserJoin(lstUserID, strUserList);
}

void CSDKCustomUIWorkFlow::onUserLeft(ZOOM_SDK_NAMESPACE::IList<unsigned int >* lstUserID, const zchar_t* strUserList)
{
	if(m_pCustomUIEvent)
...
void CSDKCustomUIWorkFlow::onUserAudioStatusChange(ZOOM_SDK_NAMESPACE::IList<ZOOM_SDK_NAMESPACE::IUserAudioStatus* >* lstAudioStatusChange, const zchar_t* strAudioStatusList)
{
	if(m_pCustomUIEvent)
