	...
	public IMeetingChatCtrlEvent
{
	...
	void (*turnOnSendShareVideoAndAudio_)();
	void (*turnOffSendShareVideoAndAudio_)();
	void (*onChatMessageReceived_)(IChatMsgInfo*);


public:
	MeetingChatEventListener(void (*turnOnSendShareVideoAndAudio_)(), void (*turnOffSendShareVideoAndAudio_)());
	MeetingChatEventListener(void (*onChatMessageReceived_)(IChatMsgInfo*));
