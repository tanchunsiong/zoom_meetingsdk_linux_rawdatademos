...
import { dockerLogin, killContainers, listContainers, startContainers } from './ecs.js';
...
app.post('/api/ecs/auth-info', asyncRoute(async (_req, res) => {
  res.json({
    ok: true,
...
app.get('/api/ecs/tasks', asyncRoute(async (_req, res) => {
